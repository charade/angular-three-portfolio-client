...
export class CryptrendsDetailsComponent {
  ...
  readonly description =
    'I did this project to better understand the world of cryptocurrencies. It allows to track the trends depending on the selected currency. User can check the fluctuation of a crypto as a graph on a details page over the last 30 days.';
}
